# This script is a rough prototype for the use of pymagicc within REMIND
...
# #FIXME argument. This should be provided by the REMIND script or inferred from run_path
...
fname_output = os.path.join(run_path ,'scm_output.csv')
...
# This creates a temporary copy of MAGICC (instantiating pymagicc.MAGICC6), 
# runs it and collects all results in an scmdata.ScmRun object
# Repeated runs with the same instance of MAGICC6 should be faster
...
# #FIXME: Set up the non loading of monthly data to squash warnings
...
results.to_iamdataframe().swap_time_for_year().as_pandas().to_csv(fname_output)
